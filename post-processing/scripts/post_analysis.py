                        ...
                        if "lattice" in property:
                            ...
                            for cell in row:
                                try:
                                    ...
                                    data_row.append(float('nan'))  # Use NaN for non-convertible cells
...
for property in ["master_lattice_params"]:#["master_densities", "master_lattice_params", "master_rdf_values", "master_temperature", "master_time_temp"]:
